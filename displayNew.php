...
<!-- /com.omniupdate.div --></div></div><div class="pageWidth"><div class="mainNavOuter"><!-- com.omniupdate.div path="/dean-of-students/hnav.html" label="hnav" --><!-- com.omniupdate.editor csspath="/z-omniupdate/edit/department-header/hnav.css" width="1200" -->
...
<!-- End subnav -->
<!-- /com.omniupdate.div --></div><div class="contentBanner"> </div><div class="content contentFull"><div class="bcOuter"><!-- com.omniupdate.div path="/z-omniupdate/fakes/breadcrumb.html" label="breadcrumb" --><ul class="bc inlineList"><li><a href="/dean-of-students/"><?=$post->getTitle();?></a></li></ul><!-- /com.omniupdate.div --></div>
...
<?=$post->getData();?>
<br><br>
<p>Published on: <?=$post->getPublished();?></p>
